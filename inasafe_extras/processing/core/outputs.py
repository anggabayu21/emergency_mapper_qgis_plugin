...
from inasafe_extras.processing.tools.system import isWindows, getTempFilenameInTempFolder
from inasafe_extras.processing.tools.vector import VectorWriter, TableWriter
