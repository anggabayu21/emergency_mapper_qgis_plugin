...
from inasafe_extras.processing.gui.MultipleInputDialog import MultipleInputDialog
from inasafe_extras.processing.gui.MultipleFileInputDialog import MultipleFileInputDialog
