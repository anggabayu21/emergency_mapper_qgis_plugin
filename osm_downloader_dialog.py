...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'osm_downloader_dialog_base.ui'))


class OsmDownloaderDialog(QDialog, FORM_CLASS):
    """Downloader for OSM data."""

    def __init__(self, parent=None, iface=None, callbackclose=None):
        ...
        self.setWindowTitle(self.tr('OpenStreetMap Downloader'))
        ...
        title = self.tr('OpenStreetMap Downloader')
        ...
        self.cancel_button.toggled.connect(self.cancel_toggled)
    ...
    def accept(self):
        ...
        error_dialog_title = self.tr('OpenStreetMap Downloader Error')
